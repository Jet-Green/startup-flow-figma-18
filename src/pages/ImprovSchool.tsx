  ...
  const courseGoals = [
    {
      ...
      description:
        "Участники освоят техники импровизации, которые помогут им мыслить нестандартно и находить оригинальные решения в условиях неопределенности.",
    },
    {
      icon: <MessageCircle className="w-6 h-6" />,
      title: "Улучшение коммуникации",
      description:
        "Музыкальная импровизация требует активного слушания и взаимодействия, что способствует развитию навыков эффективной коммуникации внутри команды.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Музыка помогает расслабиться и наладить эмоциональный контакт, что способствует лучшему восприятию информации и взаимодействию с коллегами.",
    },
  ]
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-8 mb-12">
              <div className="text-center mb-8">
                ...
                <p className="text-lg text-gray-700 max-w-4xl mx-auto">
                  В современном мире креативность и способность адаптироваться к изменениям играют ключевую роль в
                  успехе. Курс по музыкальной импровизации предлагает уникальную возможность развить эти навыки через
                  музыку. Участники научатся использовать принципы импровизации для улучшения командной работы,
                  повышения креативности и эффективного решения проблем.
                </p>
              </div>
            </div>
                  ...
                  <Card key={index} className="bg-white shadow-lg hover:shadow-xl transition-all duration-300 border-0">
                    <CardHeader className="text-center pb-4">
                      <div className="mx-auto mb-4 p-3 bg-gradient-to-br from-purple-100 to-pink-100 rounded-2xl w-fit">
                        <div className="text-purple-600">{goal.icon}</div>
                      </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="text-center">
                  ...
                  <p className="text-purple-100">
                    Участники будут вовлечены в практические упражнения, направленные на развитие импровизационных
                    навыков.
                  </p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-purple-100">
                    Регулярные сессии обратной связи, где участники смогут делиться своим опытом и получать рекомендации
                    по улучшению.
                  </p>
                </div>
              </div>
