        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Менторство для технологических стартапов, развитие креативного потенциала и стратегический консалтинг.
              Объединяю восточные и западные традиции для достижения выдающихся результатов.
            </p>
