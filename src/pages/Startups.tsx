  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Полное сопровождение технологических проектов: от разработки стратегии до привлечения инвестиций и
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Образовательная программа</h2>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Полный спектр услуг для стартапов</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                  ...
                  <div className="flex items-start space-x-3 mb-4">
                    ...
                    <div className="flex-1">
                      <h3 className="font-semibold text-gray-900 mb-2">
                        {service.title}
                        {service.included && (
                          <Badge className="ml-2 bg-blue-100 text-blue-600 text-xs">В упаковке</Badge>
                        )}
                      </h3>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Готовы запустить успешный стартап?</h2>
